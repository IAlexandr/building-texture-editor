...
import {fcBuildingsToNedb, addressesToNedb, pointsToNedb, fcBuildingComplexToNedb} from './../modules/sync';
...
router.get('/', function (req, res) {
  async.parallel({
    ...
    ResultBuildings: (callback) => {
      try {
        if (fs.statSync(stroeniyaResultFilePath)) {
          const fc = require(stroeniyaResultFilePath);
