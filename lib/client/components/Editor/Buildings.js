...
export default class Buildings extends Component {
  ...
  rebuildBuildingWalls (oldBuildingInfo, newBuilding) {
    // oldBuildingInfo = Object.assign({}, oldBuildingInfo);
    // const tempBuildingsInfo = this.state.tempBuildingsInfo;
    // tempBuildingsInfo[newBuilding.properties.ID] = oldBuildingInfo;
    // this.setState({
    //   tempBuildingsInfo
    // });
      ...
      <div>
        ...
        />
        {
          /*
           ...
           //const buildingsInfo = Object.assign({}, this.state.buildingsInfo);
           //buildingsInfo[this.props.selectInfo.ID] = tempBuildingInfo;
