...
function drag (e) {
  ...
  setImageToWall(edit);
  dragEvent({ points: gpoints.map(i => ({ ...i, x: i.x  * factor, y: i.y * factor })), edit: edit.toDataURL("image/png") });
}
...
export function setDragEvent (dEvent) {
  dragEvent = dEvent;
}
export function getOriginalImage (_img, originalPoints) {
