...
class Editor extends Component {
  constructor (props) {
    ...
    this.state = {
      addressState: null,
      images: {},
      copyTextureRegisterNo: this.props.selectInfo.registerNo || "0",
      copyTextureID: this.props.selectInfo.ID || "0",
      copyTextureWallId: this.props.selectInfo.wallId || "0",
    ...
    if (
      ...
      actionButton = <FlatButton
        ...
        onClick={(() => {
          ...
          const to = {
            registerNo: this.refs.copyTextureRegisterNo,
            ID: this.props.copyTextureID,
            wallId: this.props.copyTextureWallId,
          };
