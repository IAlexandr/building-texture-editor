          ...
          <Paper style={styles.paper} zDepth={1}>
            ...
            <FlatButton
              ...
              onClick={(() => {
                ...
                Cesium.myViewer.entities.values.forEach((entity) => {
                  if (entity.ID === this.props.selectInfo.ID &&
                    typeof entity.wall.material.image._value === 'object') {
                    const { registerNo, ID, wallId, wall } = entity;
                    resultTextures.push({ registerNo, ID, wallId, image: wall.originImg });
                  }
                });
                console.log(resultTextures);
                this.props.saveBuildingTextures(this.props.selectInfo.registerNo, resultTextures);
              }).bind(this)}
            />
            <FlatButton
...
export default connect(mapStateToProps, {
  ...
  saveBuildingTextures: buildingsActions.saveBuildingTextures,
