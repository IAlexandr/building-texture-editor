...
class AddressList extends Component {
  ...
  render () {
    if (this.props.children) {
      let addressInfo;
      if (this.props.addressList.data && !this.props.addressList.loading) {
        addressInfo = this.props.addressList.data.filter((addr) => {
          return addr.RegisterNo === this.props.params.registerNo;
        });
